...
p_word_lib = probabilities.probability_word_given_outcome(distinct_vocab, vocab_lib, smoother)
p_word_con = probabilities.probability_word_given_outcome(distinct_vocab, vocab_con, smoother)
